...
class CredentialManager:
    ...
    def __init__(self) -> None:
        ...
        if not self.keyring_available:
            logger.warning("Keyring not available, falling back to encrypted local storage")
            if not self.crypto_available:
                logger.error("Neither keyring nor cryptography available - credentials will not be secure!")
