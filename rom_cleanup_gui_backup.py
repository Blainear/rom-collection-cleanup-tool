...
class ROMCleanupGUI:
    ...
    def setup_ui(self):
        ...
        ttk.Label(
            advanced_frame, text="TheGamesDB API Configuration", style="Subtitle.TLabel"
        ).grid(row=0, column=0, sticky=tk.W, pady=(0, 15))

        ttk.Label(advanced_frame, text="API Key:", style="Dark.TLabel").grid(
        ...
        button_frame = ttk.Frame(advanced_frame, style="Dark.TFrame")
        button_frame.grid(row=3, column=1, sticky=tk.W, pady=(0, 10), padx=(10, 0))
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get('data') and data['data'].get('games'):
                    ...
                    self.log_message("API key appears to be working but query returned no results")
            elif response.status_code == 401:
