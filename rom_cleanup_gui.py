...
class ROMCleanupGUI:
    ...
    def scan_roms(self, directory, preferred_region, keep_japanese_only, operation):
        ...
        try:
            ...
            rom_files = []
            rom_extensions = {
                ".zip", ".7z", ".rar", ".iso", ".cue", ".bin", ".img",
                ".smc", ".sfc", ".nes", ".n64", ".z64", ".v64",
                ".gb", ".gbc", ".gba", ".nds", ".3ds",
                ".smd", ".gen", ".sms", ".gg", ".32x", ".cdi", ".sat",
                ".pbp", ".cso"
            }
            ...
            self.process_duplicates(rom_groups, preferred_region, keep_japanese_only, operation)
